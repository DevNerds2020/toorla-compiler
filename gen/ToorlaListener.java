...
public interface ToorlaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ToorlaParser#otherParamas}.
	 * @param ctx the parse tree
	 */
	void enterOtherParamas(ToorlaParser.OtherParamasContext ctx);
	/**
	 * Exit a parse tree produced by {@link ToorlaParser#otherParamas}.
	 * @param ctx the parse tree
	 */
	void exitOtherParamas(ToorlaParser.OtherParamasContext ctx);
	/**
